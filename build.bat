...
set LinkerFlags=-INCREMENTAL:NO -opt:ref user32.lib gdi32.lib shell32.lib opengl32.lib -LIBPATH:%GLFWLibDirectory% glfw3.lib -LIBPATH:%GLEWLibDirectory% glew32sd.lib
